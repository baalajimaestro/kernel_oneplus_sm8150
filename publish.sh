...
cp /home/baalajimaestro/kernel_oneplus_sm8150/out/arch/arm64/boot/Image.gz-dtb /home/baalajimaestro/AnyKernel3
cd /home/baalajimaestro/AnyKernel3
export ZIPNAME="Retarded-Kernel-CI-$(date +%Y%m%d).zip"
zip -r9 "${ZIPNAME}" -- *
